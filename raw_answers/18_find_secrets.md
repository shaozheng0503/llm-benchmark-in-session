...
- **行 11: SLACK Webhook URL** —— 🟠 中危 —— 字面值 `https://hooks.slack.example/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX`，泄露后任何人都可以向该 SLACK 频道发消息（钓鱼、垃圾信息、机密外泄）。
...
1. **立即撤销所有泄露的密钥**（AWS、GitHub PAT、SLACK webhook），生成新值。
